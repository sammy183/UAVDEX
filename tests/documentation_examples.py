...
# Component Initialization
design = ud.PointDesign() 				# initialize PointDesign object
design.Motor('C-4130/20', nmot = 1)		# add a motor, and specify the # of motors
design.Battery('Gaoneng_8S_3300') 		# add a battery 
design.Prop('18x12E') 					# add a propeller
...
design.ContourPlot(propQ = 'eta_drive',
                  Uinf_mps = np.linspace(0, 45, 300), 
                  dT = 100,
                  h_m = 50, 
                  Voc = np.linspace(3.5, 4.2, 300))
